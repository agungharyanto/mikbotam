                    ...
                    <table  id="hotspot" class="table display nowrap " width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href='#useredit' class='btn btn-success' data-toggle='modal' onclick='edituser();' data-id="<?=$baris['.id'];?>"><i class='fa fa-pencil-square-o'></i></a>&nbsp;</td>
