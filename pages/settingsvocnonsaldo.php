<?php
	...
	if (isset($_POST['save'])) {
		...
		if (!empty($_POST['vocname_21'])) {
            ...
            $updatedata = upvocnon($sendfungsi, $id);
          echo "<script>setTimeout(\"location.href = '?Mikbotam=SettingsVocnonsaldo';\");</script>"; 
	}
...
<script src="../js/MikbotamColorSelector.js"></script>
   ...
   <h1 class="tx-danger tx-center">VOUCHER NON SALDO</h1>
                   	<form method="post">
