    ...
    <div class="sl-pagebody">
        <div class="bd-primary mg-t-10">
            <div class="card bd-primary">
                <div class="card-header bg-primary tx-white"> <i class="fa fa-gear"></i> Add Servers MikroTik &nbsp; | &nbsp;&nbsp;<i onclick="Reload();" class="fa fa-refresh pointer " title="Reload data"></i></div>
                <div class="card-body pd-sm-15">
                    <form action="index.php?Mikbotam=Servers" autocomplete="off" method="post" name="servers">
