							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" name="Text_List_1" value="<?=$datajson[0]['Text_List'];
											?>">
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="price_2" value="<?=$datajson[0]['price'];
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="markup_0" value="<?php if (!empty($datajson[0]['markup'])) { echo $datajson[0]['markup'];
												} else { echo '0';
												}
												?>" onkeypress="return isNumber(event)">
											</div>
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											...
											<input id="colorful1" class="form-control" name="length_1" type="number" min="1" max="10" value="<?php if (!empty($datajson[0]['length'])) { echo $datajson[0]['length'];
											} else { echo '1';
											}
											?>" onkeypress="return isNumber(event)" />
										</div>
							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										...
										<label class="col-sm-4 form-control-label">Text List</label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" name="Text_List_2" value="<?=$datajson[1]['Text_List'];
											?>">
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="price_6" value="<?=$datajson[1]['price'];
												?>" onkeypress="return isNumber(event)">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="markup_1" value="<?php if (!empty($datajson[1]['markup'])) { echo $datajson[1]['markup'];
												} else { echo '0';
												}
												?>" onkeypress="return isNumber(event)">
											</div>
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											...
											<input id="colorful2" class="form-control" name="length_2" type="number" min="1" max="10" value="<?php if (!empty($datajson[1]['length'])) { echo $datajson[1]['length'];
											} else { echo '1';
											}
											?>" onkeypress="return isNumber(event)" />
										</div>
							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										...
										<label class="col-sm-4 form-control-label">Text List</label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" name="Text_List_3" value="<?=$datajson[2]['Text_List'];
											?>">
										</div>
									</div>
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="price_10" value="<?=$datajson[2]['price'];
												?>" onkeypress="return isNumber(event)">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="markup_2" value="<?php if (!empty($datajson[2]['markup'])) { echo $datajson[2]['markup'];
												} else { echo '0';
												}
												?>" onkeypress="return isNumber(event)">
											</div>
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											...
											<input id="colorful3" class="form-control" name="length_3" type="number" min="1" max="10" value="<?php if (!empty($datajson[2]['length'])) { echo $datajson[2]['length'];
											} else { echo '1';
											}
											?>" onkeypress="return isNumber(event)" />
										</div>
							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Text List</label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" name="Text_List_4" value="<?=$datajson[3]['Text_List'];
											?>">
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="price_14" value="<?=$datajson[3]['price'];
												?>" onkeypress="return isNumber(event)">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="markup_3" value="<?php if (!empty($datajson[3]['markup'])) { echo $datajson[3]['markup'];
												} else { echo '0';
												}
												?>" onkeypress="return isNumber(event)">
											</div>
									...
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											...
											<input id="colorful4" class="form-control" name="length_4" type="number" min="1" max="10" value="<?php if (!empty($datajson[3]['length'])) { echo $datajson[3]['length'];
											} else { echo '1';
											}
											?>" onkeypress="return isNumber(event)" />
										</div>
							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										...
										<label class="col-sm-4 form-control-label">Text List</label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" name="Text_List_5" value="<?=$datajson[4]['Text_List'];
											?>">
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="price_18" value="<?=$datajson[4]['price'];
												?>" onkeypress="return isNumber(event)">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="markup_4" value="<?php if (!empty($datajson[4]['markup'])) { echo $datajson[4]['markup'];
												} else { echo '0';
												}
												?>" onkeypress="return isNumber(event)">
											</div>
									...
									<div class="row mg-t-10 mg-b-10">
										...
										<div class="row mg-t-8">
											<label class="col-sm-4 form-control-label">Length Character  </label>
											<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<input id="colorful5" class="form-control" name="length_5" type="number" min="0" max="10" value="<?php if (!empty($datajson[4]['length'])) { echo $datajson[4]['length'];
												} else { echo '1';
												}
												?>" onkeypress="return isNumber(event)" />
											</div>
								...
								<div class="card bd-primary">
									...
									<div class="card-body pd-sm-15">
										...
										<div class="row mg-t-8">
											...
											<label class="col-sm-4 form-control-label">Text List</label>
											<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<input type="text" class="form-control" name="Text_List_6" value="<?=$datajson[5]['Text_List'];
												?>">
											</div>
										</div>
										<div class="row mg-t-8">
											...
											<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="price_22" value="<?=$datajson[5]['price'];
													?>" onkeypress="return isNumber(event)">
												</div>
											</div>
										</div>
										<div class="row mg-t-8">
											...
											<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="markup_5" value="<?php if (!empty($datajson[5]['markup'])) { echo $datajson[5]['markup'];
													} else { echo '0';
													}
													?>" onkeypress="return isNumber(event)">
												</div>
										...
										<div class="row mg-t-8">
											<label class="col-sm-4 form-control-label">Length Character  </label>
											<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<input id="colorful6" class="form-control" name="length_6" type="number" min="0" max="10" value="<?php if (!empty($datajson[5]['length'])) { echo $datajson[5]['length'];
												} else { echo '1';
												}
												?>" onkeypress="return isNumber(event)" />
							...
							<div class="card bd-primary">
								...
								<div class="card-body pd-sm-15">
									...
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Nama Voucher  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control"  value="Nama voucher">
										</div>
									</div>
										<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Text List</label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" value="Voucher 1 harga .... ">
										</div>
									</div>
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Harga Voucher  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control"  value="Harga Voucher">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										...
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<div class="input-group">
												...
												<input type="text" class="form-control"  value="Pengurangan saldo /bonus -saldo">
											</div>
										</div>
									</div>
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Server  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<input type="text" class="form-control"  value="Nama server voucher">
										</div>
									</div>
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Profile  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
												<input type="text" class="form-control"  value="Nama Profile voucher">
										</div>
									</div>
									...
									<div class="row mg-t-10 mg-b-10">
										<label class="col-sm-4 form-control-label">Type Char  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control" value="Type Character voucher">
										</div>
									</div>
									<div class="row mg-t-10 mg-b-10">
										<label class="col-sm-4 form-control-label">Type Login  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
											<input type="text" class="form-control"  value="Type voucher">
										</div>
									</div>
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Length Character  </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
	<input type="text" class="form-control"  value="Panjang Character Username/Password voucher">
										</div>
									</div>		
									<div class="row mg-t-8">
										<label class="col-sm-4 form-control-label">Qr Code Color </label>
										<div class="col-sm-8 mg-t-10 mg-sm-t-0">
	<input type="text" class="form-control"value="Warna Qrcode voucher">
